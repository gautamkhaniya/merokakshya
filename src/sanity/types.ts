...
// Query: *[_type == "note" &&     university == $university &&    degree == $degree &&    year == $year &&    semester == $semester &&    subject == $subject &&    (type == "SYLLABUS" || type == "PYQ" || type == "ONE-SHOT" || type == "VIDEO-MATERIAL" || type == "HANDWRITTEN-NOTES") &&    slug.current != $currentSlug &&    defined(slug.current)  ] | order(title asc) [0...3] {    _id,    title,    slug,    syllabus,    isPremium,    tier  }
