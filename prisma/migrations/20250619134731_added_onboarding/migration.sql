...
-- CreateEnum
CREATE TYPE "Semester" AS ENUM ('FIRST_SEMESTER', 'SECOND_SEMESTER', 'THIRD_SEMESTER', 'FOURTH_SEMESTER', 'FIFTH_SEMESTER', 'SIXTH_SEMESTER', 'SEVENTHEIGHTH_SEMESTER', 'PASSED');
